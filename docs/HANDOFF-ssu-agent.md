...
| **M2** vault 반영 | ✅ **2026-09-02 완료** — `study_cli.py`. 28건·오류 0·멱등 확인 |
| **M3** 자료 | ✅ **2026-09-02 완료** — Commons 는 인증 없이 받아진다(§10-1 해소). 요약은 미착수 |
| **대시보드** | ✅ **2026-09-02** — `meta.json` 이 두 저장소 사이의 계약이다 |
| **M4** 시험 | 미착수 |
